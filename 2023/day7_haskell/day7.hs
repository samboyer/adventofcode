...
hand_to_score s = (hand_to_type s, hand_to_value s)
...
-- main = putStrLn (show (reduce [(1,2), (3,4)]))

-- main = putStrLn (show ((read "234"::Integer)+1))

-- main = putStrLn (show (input_to_parts test_input))

-- main = putStrLn (show (sort [(1,2,"aa"), (2,1, "bb"), (2,5, "cc")]))


-- main = putStrLn (show (process test_input))



main = do
    print (show (process real_input))
    -- print (show (sort "KTJJT"))
    -- print (show (stringCharFreqs "KTJJT"))
    -- print (show (map line_to_score_and_bet (input_to_parts test_input)))
