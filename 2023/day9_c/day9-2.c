...
int get_prev_term_in_sequence(int *nums, int nums_len){
    ...
    return nums[0] - get_prev_term_in_sequence(diffs, nums_len-1);
}
...
// 10 13 16 21 30 45";
    ...
    for (int i=0; *(lines+i); i++){
        ...
        sum += get_prev_term_in_sequence(nums, nums_len);
    }
